 ...
 <div class="block full">
        <div class="block-title">
          <div class="row">
            ...
            <div class="col-md-9">
                  <a href="form_peserta_meeting.php" style="float:right; margin-right:20px;"><button class="btn btn-success" style="margin:20px 0px;" onclick="hide_table()"><i class="fa fa-plus"></i>&nbsp;ABSEN DISINI</button></a><br>
            </div>
          </div>
        </div>
            ...
            <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                <thead>
                    <tr>
                        ...
                        <th style="width: 20px;">Waktu Absen</th>
                ...
                <tbody>
                  ...
                  if(isset($_GET['delete'])){
                   ...
                   $no = 1;
                    $sql = mysql_query("SELECT * FROM `tb_peserta_absensi` JOIN tb_meeting ON tb_peserta_absensi.ID_meeting = tb_meeting.ID_meeting WHERE tb_peserta_absensi.ID_karyawan = '$_SESSION[ID_karyawan]' ORDER BY ID_absensi");
