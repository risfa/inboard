...
<div id="modal-checkout" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="push" action="page_app_estore.php" method="post">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="modal-title"><strong>Checkout</strong></h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <h4 class="page-header text-center"><i class="fa fa-credit-card"></i> <strong>Credit Card</strong></h4>
                        </div>
                        ...
                        <div class="col-xs-12">
                            <h4 class="page-header text-center"><i class="fa fa-coins"></i> <strong>Other Payment Methods</strong></h4>
                        </div>
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="form-group text-center">
                                ...
                                <div>
                                    ...
                                    <label class="radio-inline" for="checkout-payment-cash">
                                        <input type="radio" id="checkout-payment-cash" name="checkout-payments" value="bank"> Bank Transfer
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-effect-ripple btn-success"><i class="fa fa-check"></i> Complete Purchase</button>
                </div>
            </form>
        </div>
    </div>
