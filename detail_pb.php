        ...
        <div class="block full">
            <div class="block-title">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <!-- <a href="panel_kontrol_pb.php" style="float:right; margin-right:20px;"><button class="btn btn-info" style="margin:20px 0px;" onclick="hide_table()"><i class="fa fa-chevron-left"></i>&nbsp; KEMBALI</button></a><br> -->
                    </div>
                </div>
            </div>
