...
<body>
  <?php
  $tampil = mysql_fetch_array(mysql_query("SELECT * FROM tb_permohonan_cuti"));
?>
<br><br><br>
<div class="container">
  <div class="row">
   <center>
      <img style="width: 50%;" class="img-fluid" src="../img/checkmark.png">
      </center>
    </div>
  <br><br>
  <div class="row">
    <div class="col-12">
      Respond "SETUJU" telah di kirimkan kepada karyawan terkait . Terima Kasih
    </div>
  </div>
</div>
