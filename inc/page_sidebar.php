...
<div id="sidebar" >
    ...
    <div id="sidebar-brand" class="themed-background">
        <a href="index.php" class="sidebar-title" style="background-color: #ef3e33; height: 54px;">
            <!-- <i class="fa fa-cube"></i> <span class="sidebar-nav-mini-hide">IntraAPP</span> -->
            <img src="img/white_logo.png" alt="" style="height:35px">
        </a>
    </div>
    <!-- END Sidebar Brand -->
