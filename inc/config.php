...
if($_SESSION['username']){
  // echo "<script>alert('Ada Data')</script>";
}else{
  $cek_halaman  = strpos($actual_link,'login');
  if($cek_halaman < 1){
...
$template = array(
    ...
    'title'             => 'INBOARD',
    'description'       => 'Intra App is Ardgroup Administrative Software',
    ...
    'layout'            => 'sidebar-visible-lg-full',
